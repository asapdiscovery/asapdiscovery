...
def pymol_alignment(pdb_path, ref_path, out_path, sel_dict={}):
    ...
    pymol.cmd.align(
        "polymer and name CA and mobile and chain A",
...
def align_all_pdbs(
    pdb_list, pdb_dir_path, ref_path=None, ref_name=None, sel_dict={}
):
    if not ref_path:
        ref = pdb_list[0]
