...
def prepend_fragment_molecules(mols, fragments, protonation_states):
    ...
    for fragid, cid in fragments.items():
        if cid not in titles:
            ...
            fragment = load_fragment(fragid, title=cid, protonation_state=protonation_state)
...
if __name__ == '__main__':
    ...
    for prefix in molecule_sets_to_dock:
        ...
        prepend_fragment_molecules(target_molecules, fragments, receptor_protonation_states)
