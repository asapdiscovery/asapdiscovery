...
def main():
    ...
    all_pairs = {p for l in correct_dict.values() for p in l}  # noqa: E741
    all_pairs.update({p for l in incorrect_dict.values() for p in l})  # noqa: E741
    ...
    membership_arr = np.vstack(
        [[p in correct_dict[l] for l in labs] for p in all_pairs]  # noqa: E741
    )
