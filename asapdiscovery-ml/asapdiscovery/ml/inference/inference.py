...
class StructuralInference(InferenceBase):
    ...
    def predict_from_structure_file(self, pose: Union[Path, List[Path]]) -> Union[np.ndarray, float]:
        ...
        pose = [DockedDataset._load_structure(p, ) for p in pose]
    ...
    def predict_from_pose(self, pose: Union[Dict, List[Dict]]) -> Union[np.ndarray, float]:
        """
