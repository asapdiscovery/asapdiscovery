...
def pdbs_from_yaml():
    ...
    yaml_file = pkg_resources.resource_filename("asapdiscovery-data", "data/mers-structures.yaml")
...
class TestAsapPDB:
    ...
    def test_download_cif(self, tmp_path):
        ...
        pdb_id = "8DGY"
        file_path = pathlib.Path(download_pdb_structure(pdb_id, tmp_path, file_format="cif"))
    ...
    def test_download_cif_assembly(self, tmp_path):
        ...
        pdb_id = "8DGY"
        file_path = pathlib.Path(download_pdb_structure(pdb_id, tmp_path, file_format="cif1"))
