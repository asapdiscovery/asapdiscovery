...
class PosteraFactory(BaseModel):
    ...
    molecule_set_name: str = Field(..., description="Name of the molecule set to pull from Postera")
    ...
    def pull(self) -> List[Ligand]:
        ...
        ligands =          [
          Ligand.from_smiles(smiles=mol.smiles, ids=LigandIdentifiers(manifold_api_id=mol.id))
