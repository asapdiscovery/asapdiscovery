...
def protein_prep(
    ...
    alchemy_compounds_sdf: Optional[str] = None,
    alchemy_compounds_postera: Optional[str] = None,
    ...
    if input_json is not None:
        ...
        inputs = ProteinPrepInputs(
            ...
            alchemy_compounds_sdf=alchemy_compounds_sdf,
            alchemy_compounds_postera=alchemy_compounds_postera,
            cache_dir=cache_dir,
