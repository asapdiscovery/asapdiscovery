...
def spruce_protein(
    ...
    return_du : bool, optional
        Whether to return a design unit (DU) as the output. If True, the function will return the DU generated by the OESpruce pipeline.
        If False, the function will return the prepared protein structure as an oechem.OEGraphMol. Default is False.

    seqres : str, optional
        The SEQRES string of the protein. If provided, the SEQRES metadata will be added to the structure before applying the OESpruce pipeline.
        Default is None.
    ...
    site_residue : str, optional
        The site residue used to define the binding site of the protein. i.e. "HIS:41: :A:0:".
    ...
    Returns
    -------
    oechem.OEDesignUnit or oechem.OEMol
        The prepared protein structure or a DU generated by the OESpruce pipeline if `return_du` is True.
