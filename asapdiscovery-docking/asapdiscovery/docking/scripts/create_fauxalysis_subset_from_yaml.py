"""
The purpose of this script is to move a subset of the fauxalysis directory into a new
directory. The subsetting is done based on the names of PDB files contained in a yaml
file passed to the script. It also handles getting a new combined SDF file for only the
complexes in selection
Example Usage:
